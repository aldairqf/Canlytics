...
# One-directory build — faster startup than onefile; output is a folder under dist\Windows.
# Use: .venv\Scripts\pyinstaller.exe --clean --noconfirm --distpath "dist\Windows" --workpath "build\Windows" Canlytics-dir.spec
